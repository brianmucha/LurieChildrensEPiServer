...
namespace LurieChildrensFoundation.Home.Controllers.Blocks
{
	/// <summary>
	/// Returns a partial view using the <see cref="PageListBlockViewModel"/>.
	/// </summary>
	public class PageListBlockController : BlockController<PageListBlock>
	{
		...
		public override ActionResult Index(PageListBlock currentBlock)
		{
			...
			var editingHints = ViewData.GetEditHints<PageListBlockViewModel, PageListBlock>();
