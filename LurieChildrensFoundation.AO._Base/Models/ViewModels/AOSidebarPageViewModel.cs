...
{
	/// <summary>
	/// Returns a Page View Model for a <see cref="AOSidebarPage"/>.
	/// </summary>
	public class AOSidebarPageViewModel
	{
		/// <summary>
		...
		/// </remarks>
		public static AOSidebarPageViewModel<T> Create<T>(T page) where T : AOSidebarPage
		{
			return new AOSidebarPageViewModel<T>(page);
		}
	}

	/// <summary>
	/// Defines a Page View Model for a <see cref="AOSidebarPage"/>.
	/// </summary>
	public class AOSidebarPageViewModel<T> : IAOBasePageViewModel<T> where T : AOSidebarPage
	{
		public AOSidebarPageViewModel(T currentPage)
		{
