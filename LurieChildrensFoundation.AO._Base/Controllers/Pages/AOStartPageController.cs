...
{
	/// <summary>
	/// This Page Controller provides the implementation for a <see cref="AOStartPage"/>.
	/// </summary>
	public class AOStartPageController<T> : AOBasePageController<T> where T : AOStartPage
	{
		/*
